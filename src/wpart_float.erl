...
handle_call(E) ->
    Name = wpartlib:attribute("attribute::name", "no_name_float", E),
...
get_html_tag(Name, Class, Default) when is_float(Default) ->
    get_html_tag(Name, Class, float_to_list(Default));
get_html_tag(Name, Class, Default) ->
    ...
    [{_, Parts}] = ets:lookup(templates, {wpart, float}),
